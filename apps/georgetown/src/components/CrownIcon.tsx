...
export default function CrownIcon({ size = 16, fill = "#f7a81b", className = "" }: CrownIconProps) {
  return (
    <svg
      width={size}
      height={size}
