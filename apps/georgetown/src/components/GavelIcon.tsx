...
export default function GavelIcon({ size = 16, fill = "#0067c8", className = "" }: GavelIconProps) {
  return (
    <svg
      width={size}
      height={size}
