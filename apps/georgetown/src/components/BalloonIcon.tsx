...
export default function BalloonIcon({ size = 16, fill = "#901f93", className = "" }: BalloonIconProps) {
  return (
    <svg
      width={size}
      height={size}
