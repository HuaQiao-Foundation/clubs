interface CharityIconProps {
  size?: number
  fill?: string
  className?: string
}

export default function CharityIcon({ size = 16, fill = "#00adbb", className = "" }: CharityIconProps) {
  return (
    <svg
      width={size}
      height={size}
